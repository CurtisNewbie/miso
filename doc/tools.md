...
```sh
go install github.com/curtisnewbie/miso/cmd/misogen@v0.4.22
```
...
```sh
go install github.com/curtisnewbie/miso/cmd/misoapi@v0.4.22
```
...
```sh
go install github.com/curtisnewbie/miso/cmd/misocurl@v0.4.22
```
...
```sh
go install github.com/curtisnewbie/miso/cmd/misoconfig@v0.4.22
```
...
```sh
go install github.com/curtisnewbie/miso/cmd/misopatch@v0.4.22
```
