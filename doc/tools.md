...
```sh
go install github.com/curtisnewbie/miso/cmd/misogen@v0.1.26
```
...
# misogen, current miso version: v0.1.26
#
# Initialized module 'myapp'
# Installing dependency: github.com/curtisnewbie/miso/miso@v0.1.26
...
```sh
go install github.com/curtisnewbie/miso/cmd/misoapi@v0.1.26
```
...
#
#   Supported miso version: v0.1.26
#
# Usage of misoapi:
#   -debug
#         Enable debug log
...
```sh
go install github.com/curtisnewbie/miso/cmd/misocurl@v0.1.26
```
...
```sh
go install github.com/curtisnewbie/miso/cmd/misoconfig@v0.1.26
```
