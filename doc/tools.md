...
```sh
go install github.com/curtisnewbie/miso/cmd/misogen@v0.2.0
```
...
# misogen, current miso version: v0.2.0
#
# Initialized module 'myapp'
# Installing dependency: github.com/curtisnewbie/miso/miso@v0.2.0
...
```sh
go install github.com/curtisnewbie/miso/cmd/misoapi@v0.2.0
```
...
```sh
go install github.com/curtisnewbie/miso/cmd/misocurl@v0.2.0
```
...
```sh
go install github.com/curtisnewbie/miso/cmd/misoconfig@v0.2.0
```
