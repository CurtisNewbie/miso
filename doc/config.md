...
| server.health-check-interval              | health check interval (was named 'consul.healthCheckInterval' before 'v0.2.0')                                                                                                         | 5s            |
| server.health-check-timeout               | health check timeout (was named 'consul.healthCheckTimeout' before 'v0.2.0')                                                                                                           | 3s            |
