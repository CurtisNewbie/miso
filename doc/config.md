...
| consul.healthCheckUrl                   | health check url. (deprecated since v0.1.23, use `server.health-check-url` instead) |                    |
...
| mysql.connection.parameters | connection parameters (slices of strings)                                           | `[]string{"charset=utf8mb4", "parseTime=True", "loc=Local", "readTimeout=30s", "writeTimeout=30s", "timeout=3s", "collation_connection=utf8mb4_general_ci"}` |
