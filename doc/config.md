...
| consul.register-name                       | registered service name (was named `consul.registerName` before `v0.2.0`)                                                                                | `"${app.name}"`    |
| consul.register-address                    | registered service address (was named `consul.registerAddress` before `v0.2.0`)                                                                          | `"${server.host}"` |
| consul.consul-address                      | consul server address (was named `consul.consulAddress` before `v0.2.0`)                                                                                 | localhost:8500     |
| consul.health-check-failed-deregister-time | for how long the current instance is deregistered after first health check failure (was named `consul.healthCheckFailedDeregisterAfter` before `v0.2.0`) | 30m                |
| consul.fetch-server-interval               | fetch server list from Consul in ever N seconds (was named `consul.fetchServerInterval` before `v0.2.0`)                                                 | 30                 |
| consul.enable-deregister-url               | enable endpoint for manual Consul service deregistration (was named `consul.enableDeregisterUrl` before `v0.2.0`)                                        | false              |
| consul.deregister-url                      | endpoint url for manual Consul service deregistration (was named `consul.deregisterUrl` before `v0.2.0`)                                                 | /consul/deregister |
...
| server.health-check-url                   | health check url (was named `consul.healthCheckUrl` before `v0.2.0`)                                                                                                                   | /health       |
| server.health-check-interval              | health check interval, it's only used for service discovery, e.g., Consul (was named `consul.healthCheckInterval` before `v0.2.0`)                                                     | 5s            |
| server.health-check-timeout               | health check timeout, it's only used for service discovery, e.g., Consul (was named `consul.healthCheckTimeout` before `v0.2.0`)                                                       | 3s            |
...
| server.graceful-shutdown-time-sec         | time wait (in second) before whole app server shutdown (previously, before `v0.1.12`, it only applies to the http server) (was named `server.gracefulShutdownTimeSec` before `v0.2.0`) | 30            |
...
| server.api-doc.enabled                    | generate api doc (was named `server.generate-endpoint-doc.enabled` before `v0.2.0`)                                                                                                    | true          |
| server.api-doc.web.enabled                | build webpage for the generated api doc (was named `server.generate-endpoint-doc.web.enabled` before `v0.2.0`)                                                                         | true          |
| server.api-doc.file                       | generate markdown api doc to the specified file (was named `server.generate-endpoint-doc.file` before `v0.2.0`)                                                                        |               |
| server.api-doc.file-excl-tclient-demo     | the generated markdown api doc should exclude miso.TClient demo (was named `server.generate-endpoint-doc.file-excl-tclient-demo` before `v0.2.0`)                                      | false         |
| server.api-doc.file-excl-ngclient-demo    | the generated markdown api doc should exclude Angular HttpClient demo (was named `server.generate-endpoint-doc.file-excl-ng-client-demo` before `v0.2.0`)                              | false         |
| server.api-doc.file-excl-openapi-spec     | the generated markdown api doc should exclude openapi json for each endpoint (was named `server.generate-endpoint-doc.file-excl-openapi-spec` before `v0.2.0`)                         | true          |
| server.api-doc.path-prefix-app            | the generated endpoint documentation should include app name as the path prefix (was named `server.generate-endpoint-doc.path-prefix-app` before `v0.2.0`)                             | true          |
| server.api-doc.openapi-spec.server        | server address specified in openapi json doc (was named `server.generate-endpoint-doc.openapi-spec.server` before `v0.2.0`)                                                            |               |
| server.api-doc.openapi-spec.file          | path to generated openapi json for all endpoints (was named `server.generate-endpoint-doc.openapi-spec.file` before `v0.2.0`)                                                          |               |
| server.api-doc.openapi-spec.path-patterns | path patterns for endpoints in openapi json (`slice of string`) (was named `server.generate-endpoint-doc.openapi-spec.path-patterns` before `v0.2.0`)                                  |               |
