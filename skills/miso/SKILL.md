...
- **Distributed Tasks** - Cron-based scheduling with master-worker architecture using Redis
...
**Distributed Tasks:** [distributed-tasks.md](references/distributed-tasks.md)
- Cron scheduling, master-worker pattern, task queues, hooks
