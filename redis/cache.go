...
func (r *LazyObjRCache[T]) Del(ec core.Rail, key string) error {
	return r.lazyRCache.Del(ec, key)
}

// Get from cache else run supplier
func (r *LazyObjRCache[T]) GetElse(ec core.Rail, key string, supplier func() (T, bool, error)) (val T, ok bool, e error) {
...
// Put value to cache
func (r *LazyRCache) Put(ec core.Rail, key string, val string) error {
	return r.rcache().Put(ec, key, val)
}

// Get from cache
func (r *LazyRCache) Get(ec core.Rail, key string) (val string, e error) {
	return r.rcache().Get(ec, key)
}

// Get from cache else run supplier
func (r *LazyRCache) GetElse(ec core.Rail, key string, supplier func() (string, error)) (val string, e error) {
	return r.rcache().GetElse(ec, key, supplier)
}

// Remove value from cache
func (r *LazyRCache) Del(ec core.Rail, key string) error {
	return r.rcache().Del(ec, key)
}

// Put value to cache
func (r *RCache) Put(ec core.Rail, key string, val string) error {
...
// Remove value from cache
func (r *RCache) Del(ec core.Rail, key string) error {
	_, e := RLockRun(ec, "rcache:"+key, func() (any, error) {
...
// Get from cache
func (r *RCache) Get(ec core.Rail, key string) (val string, e error) {
...
func (r *RCache) GetElse(ec core.Rail, key string, supplier func() (string, error)) (val string, e error) {
