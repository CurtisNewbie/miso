...
func CreateWebInitFile(f *os.File) error {
	fmt.Printf("Initializing %s\n", f.Name())
	sb, writef := strutil.NewIndWritef("\t")
	writef(0, "// generated by misogen for importing misoapi generated code in main")
	writef(0, "package web")
	writef(0, "")
	writef(0, "import \"github.com/curtisnewbie/miso/miso\"")
	writef(0, "// Do not modify this if misoapi is used, misoapi may modify func body")
