					...
					{{range .Doc}}
						...
						{{if .Curl}}
							<p>
								...
								<p><pre><code style="border-radius: 10px;" class="language-sh">{{.Curl}}</code></pre></p>
							</p>
						{{end}}
						...
						{{if .JsonReqTsDef}}
							<p>
								...
								<p><pre><code style="border-radius: 10px;" class="language-ts">{{.JsonReqTsDef}}</code></pre></p>
							</p>
						{{end}}
						...
						{{if .JsonRespTsDef}}
							<p>
								...
								<p><pre><code style="border-radius: 10px;" class="language-ts">{{.JsonRespTsDef}}</code></pre></p>
							</p>
						{{end}}
