...
// Test if expected == actual, else call t.FailNow with values printed
func TestEqual[V comparable](t *testing.T, expected V, actual V) {
	caller := _callerLine()
	if expected != actual {
		t.Logf("[FAIL] %v -> Expected: %v, actual: %v", caller, expected, actual)
		t.FailNow()
	} else {
...
// Test if actual is true, else call t.FailNow with values printed
func TestTrue(t *testing.T, actual bool) {
	caller := _callerLine()
	if !actual {
		t.Logf("[FAIL] %v -> Expected: true, actual: %v", caller, actual)
		t.FailNow()
	} else {
...
// Test if actual is false, else call t.FailNow with values printed
func TestFalse(t *testing.T, actual bool) {
	caller := _callerLine()
	if actual {
		t.Logf("[FAIL] %v -> Expected: false, actual: %v", caller, actual)
		t.FailNow()
	} else {
...
// Test if value is nil, else call t.FailNow with values printed
func TestIsNil(t *testing.T, value any) {
	caller := _callerLine()
	if value != nil {
		t.Logf("[FAIL] %v -> Expected: <nil>, actual: %v", caller, value)
		t.FailNow()
	} else {
...
// Test if value is not nil, else call t.FailNow with values printed
func TestNotNil(t *testing.T, value any) {
	caller := _callerLine()
	if value == nil {
		t.Logf("[FAIL] %v -> Should not be nil", caller)
		t.FailNow()
	} else {
